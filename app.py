...
#              'wicket_left': [wicket_left], 'current_run_rate': [crr], 'last_five': [last_five]}
#         )
    ...
    if request.method == 'POST':
        try:
            ...
            if not batting_team or not bowling_team or not city:
                raise ValueError("Please select a team and city.")
            if current_score < 0 or overs <= 0 or overs > 20 or wickets < 0 or wickets > 10 or last_five < 0:
